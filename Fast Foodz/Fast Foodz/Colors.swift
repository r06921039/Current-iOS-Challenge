...
extension UIColor {
    ...
    static let gradientColors: [CGColor] = [UIColor.bluCepheus.cgColor, UIColor.mexicoBlue.cgColor, UIColor.osloBlue.cgColor, UIColor.competitionPurple.cgColor, UIColor.viola.cgColor, UIColor.rubystoneRed.cgColor, UIColor.superPink.cgColor]
